=== Gutenberg Blocks Library & Toolkit - Editor Plus by Extendify ===
...
Editor Plus now includes a template and pattern library that can be accessed by clicking the "Library" button in the menu bar of the editor. We provide a variety of templates and patterns to serve different use cases and are adding more templates every week.
Note: Editor Plus templates and patterns rely on blocks and styling applied by the Editor Plus plugin. If you uninstall Editor Plus, the templates and patterns will still display on your site, but the styling may be affected.  Additionally, stock images included in the templates are hosted on GutenbergHub.com. We recommend replacing the images or adding them to your media library directly.

## Privacy

Editor Plus uses a custom API to fetch templates and patterns from our growing library. To improve the service and stability we store logs which may contain the following:
...
For more details on our privacy policy: https://wpeditorplus.com/privacy-policy/
For more details on our terms of service: https://wpeditorplus.com/terms-of-service/
